    ...
    return(
        <div className = "text">
            ...
            <div className = "bodyText">
                ...
                <p> I created Quick-List because a lot of the to-do applications that already exist all irked me in some way. 
                    Usually, a lot of clicking. They were either too slow or required manual data
                    ...
                    Something quick, simple, and not-in-your-face.
                </p>
            </div>
        </div>
    );
